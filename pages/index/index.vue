	...
	<view class="container">
		<view>
			...
			<view class="custom-navbar">
				<!-- 左侧二维码扫描 -->
				<view class="navbar-icon" @click="navToScanPage()">
					<text class="yticon">&#xe60d;</text>
				</view>

				<!-- 搜索框 -->
				<view class="search-container" @click="navToSearchPage()">
				...
				<!-- 右侧消息 -->
				<view class="navbar-icon cart-icon" @click="navToNoticePage()">
					<text class="yticon">&#xe744;</text>
					<view class="red-dot" v-if="cartCount > 0"></view>
				</view>
			</view>
		</view>
...
export default {
	...
	onLoad() {
		this.loadData();
	    // 仅在App平台执行webview相关操作
		if (uni.getSystemInfoSync().platform === 'app-plus') {
			const currentPage = getCurrentPages()[0].$getAppWebview();
		}
	},
	//下拉刷新
	onPullDownRefresh() {
